...
class OnRobotRGNode(Node):
	...
	def __init__(self):
		...
		self.set_command_srv = self.create_service(SetCommand, "/onrobot_rg/set_command", self.handle_set_command)
	...
	def handle_set_command(self, req):
		...
		#rospy.sleep(1)
		# TODO: implement
		return SetCommand.Response(success=None, message=None)
