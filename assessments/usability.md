...
The participant in this is trained on how to use the system through written documentation and where confusion arises asks adn receives help from supervising team members.
