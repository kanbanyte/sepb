...
class CobotMethods:
	...
	def get_tray_movement_trajectories(joints, goals, gripper_outputs, cobot_movement):
		...
		if cobot_movement == CobotMovement.ASSEMBLY_TO_TRAY1.value:
			...
			replace_tray_trajectories = CobotMethods.replace_tray(joints, goals, gripper_outputs, tray_number)
		...
		if cobot_movement == CobotMovement.TRAY1_TO_ASSEMBLY.value:
			tray_number = 1
			move_home_trajectories = CobotMethods.move_home(joints, goals, gripper_outputs)
			replace_tray_trajectories = CobotMethods.move_tray(joints, goals, gripper_outputs, tray_number)
	...
	def get_all_trajectories(joints, goals, gripper_outputs, chip_number, case_number, cobot_movement):
		...
		move_home_trajectories = CobotMethods.move_home(joints, goals, gripper_outputs)
		move_chip_trajectories = CobotMethods.move_chip(joints, goals, gripper_outputs, chip_number, tray_number)
		move_case_trajectories = CobotMethods.move_case(joints, goals, gripper_outputs, case_number, tray_number)
		move_battery_trajectories = CobotMethods.move_battery(joints, goals, gripper_outputs, tray_number)
