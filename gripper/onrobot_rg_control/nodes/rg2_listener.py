...
class OnRobotRGStatusListener(Node):
	...
	def statusInterpreter(self, status):
		...
		output += 'Current width between the gripper fingers (w/o offset): ' + str(status.g_gwd / 10.0) + ' mm\n'
		...
		output += 'Current width between the gripper fingers (w offset): ' + str(status.g_wdf / 10.0) + ' mm\n'
