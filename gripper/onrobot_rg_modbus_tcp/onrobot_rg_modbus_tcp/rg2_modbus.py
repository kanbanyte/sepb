...
class communication:
	...
	The method takes the IP address and port number (as a string, e.g., '172.21.0.121' and '54321') as arguments.
	'''
	def connectToDevice(self, ip: str, port: str, changer_addr: int = 65) -> bool:
		...
		self.client = ModbusTcpClient(host=ip, port=port, stopbits=1, bytesize=8, parity='E', baudrate=115200, timeout=1)
